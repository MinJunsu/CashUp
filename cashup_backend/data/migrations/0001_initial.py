    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('down_flow', models.CharField(max_length=2, null=True, verbose_name='하락 흐름')),
                ('down_flow_confirm', models.CharField(max_length=2, null=True, verbose_name='하락 흐름 확인')),
                ('down_flow_trade', models.CharField(max_length=5, null=True, verbose_name='하락 흐름 거래')),
            ],
        ),
        migrations.CreateModel(
            name='HourData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(verbose_name='시간')),
                ('base_price', models.FloatField(verbose_name='기준 가격')),
                ('up_flow', models.CharField(max_length=2, null=True, verbose_name='상승 흐름')),
                ('up_flow_confirm', models.CharField(max_length=2, null=True, verbose_name='상승 흐름 확인')),
                ('up_flow_trade', models.CharField(max_length=5, null=True, verbose_name='상승 흐름 거래')),
            ],
        ),
    ]
